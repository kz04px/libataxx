...
TEST_CASE("Position::result()") {
    const std::pair<std::string, libataxx::Result> positions[] = {
        ...
        {"xxxxxxx/xxxxxxx/xxxxxxx/xxxxxxx/xxxxxxx/xxxxxxx/xxxxxxx x 0 1",
         libataxx::Result::BlackWin},
        {"xxxxxxx/xxxxxxx/xxxxxxx/xxxxxxx/xxxxxxx/xxxxxxx/xxxxxxx o 0 1",
         libataxx::Result::BlackWin},
        {"ooooooo/ooooooo/ooooooo/ooooooo/ooooooo/ooooooo/ooooooo x 0 1",
         libataxx::Result::WhiteWin},
        {"ooooooo/ooooooo/ooooooo/ooooooo/ooooooo/ooooooo/ooooooo o 0 1",
         libataxx::Result::WhiteWin},
        {"ooooooo/ooooooo/ooooooo/oooxxxx/xxxxxxx/xxxxxxx/xxxxxxx x 0 1",
         libataxx::Result::BlackWin},
        {"ooooooo/ooooooo/ooooooo/oooxxxx/xxxxxxx/xxxxxxx/xxxxxxx o 0 1",
         libataxx::Result::BlackWin},
        ...
        {"ooooooo/ooooooo/ooooooo/ooooxxx/xxxxxxx/xxxxxxx/xxxxxxx o 0 1",
         libataxx::Result::WhiteWin},
        {"ooooooo/ooooooo/ooooooo/ooo-xxx/xxxxxxx/xxxxxxx/xxxxxxx x 0 1",
         libataxx::Result::Draw},
        {"ooooooo/ooooooo/ooooooo/ooo-xxx/xxxxxxx/xxxxxxx/xxxxxxx o 0 1",
         libataxx::Result::Draw},
        // 50 move rule
